...
/// 获取原始顺序的所有联系人的闭包
public typealias AddressBookArrayClosure = (_ addressBookArray: [RSDIphoneContactModle])->()
/// 获取按A~Z顺序排列的所有联系人的闭包
public typealias AddressBookDictClosure = (_ addressBookDict: [String:[RSDIphoneContactModle]], _ nameKeys: [String])->()


public class RSDGetIphoneContact : NSObject {
    /**
    ...
    public class func requestAddressBookAuthorization() {
        ...
        RSDIphoneContactManager().requestAuthorizationWithSuccessClosure {
    ...
    public class func getOriginalAddressBook(addressBookArray success: @escaping AddressBookArrayClosure, authorizationFailure failure: @escaping AuthorizationFailure) {
        ...
        queue.async {
            ...
            var modelArray = [RSDIphoneContactModle]()
            RSDIphoneContactManager().getAddressBookDataSource(personModel: { (model) in
    ...
    public class func getOrderAddressBook(addressBookInfo success: @escaping AddressBookDictClosure, authorizationFailure failure: @escaping AuthorizationFailure) {
        ...
        queue.async {
            ...
            var addressBookDict = [String:[RSDIphoneContactModle]]()
            RSDIphoneContactManager().getAddressBookDataSource(personModel: { (model) in
