...
/// 一个联系人信息模型的闭包
public typealias RSDIphoneContactModleClosure = (_ model: RSDIphoneContactModle)->()
/// 授权失败的闭包
public typealias AuthorizationFailure = ()->()

class RSDIphoneContactManager: NSObject {
    ...
    func getAddressBookDataSource(personModel success: RSDIphoneContactModleClosure, authorizationFailure failure: AuthorizationFailure) {
    ...
    private func getDataSourceFrom_IOS9_Ago(personModel success: RSDIphoneContactModleClosure, authorizationFailure failure: AuthorizationFailure) {
        ...
        for personInfo in allPeopleArray {
            ...
            let model = RSDIphoneContactModle()
    ...
    // MARK: - IOS9之后获取通讯录的函数
    @available(iOS 9.0, *)
    private func getDataSourceFrom_IOS9_Later(personModel success: RSDIphoneContactModleClosure, authorizationFailure failure: AuthorizationFailure) {
