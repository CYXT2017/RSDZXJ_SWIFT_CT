...
class RSDImagePreviewCell: UICollectionViewCell {
...
//RSDImagePreviewCell的UIScrollViewDelegate代理实现
extension RSDImagePreviewCell:UIScrollViewDelegate{
