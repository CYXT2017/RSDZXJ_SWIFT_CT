...
class RSDWebView: UIView {
    ...
    /// WebView配置项
    var webConfig : RSDWkwebViewConfig?
    ...
    fileprivate func setupUI(webConfig:RSDWkwebViewConfig)  {
        // Webview的偏好设置
    ...
    func webloadType(_ target:AnyObject,_ loadType:WkwebLoadType) {
        self.target = target
        setupUI(webConfig:webConfig ?? RSDWkwebViewConfig())
...
extension RSDWebView: WKScriptMessageHandler{
...
extension RSDWebView: WKNavigationDelegate{
...
extension RSDWebView: WKUIDelegate{
